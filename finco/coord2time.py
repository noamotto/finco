...
class Space2TimeTraj(SequentialTraj):
    ...
    def p(self, tau):
        """
        Return the momentum part of the propagation for given trajectory parameter.
        ...
        p : ArrayLike of complex
            The momenta for each trajectory at the trajectory parameter.
